...
export default function GameResult() {
  ...
  const goToLeaderboard = () => {
    navigate("/leaderboard", {
      state: { sessionCode, nameTeam: actualTeamName, allowEndedLeaderboard: true }
    });
  };
  ...
  return (
    <div className={`min-h-screen ${theme.pageBg} flex justify-center font-sans pb-12 transition-colors duration-500`}>
      <div className="w-full max-w-md min-h-screen flex flex-col items-center pt-16 px-6 relative">
        ...
        <button onClick={goToLeaderboard} className="mt-3 font-bold text-[14px] px-6 py-3 rounded-xl transition-all w-fit min-w-[240px] bg-white text-[#1D2B39] border-2 border-[#1D2B39] hover:bg-gray-50 active:translate-y-[4px]">
          Lihat Leaderboard
        </button>
