...
export default function CreateSession() {
  // State untuk form POS dinamis (Default 1 POS kosong)
  ...
  return (
    <div className="min-h-screen bg-[#EBF2F8] font-sans flex justify-center pb-32">
      ...
      <div className="w-full max-w-md bg-[#EBF2F8] min-h-screen flex flex-col relative px-6 pt-12">
          ...
          {posList.map((pos, index) => (
            <div key={pos.id} className="mb-8">
              <div className="flex justify-between items-center mb-4">
                ...
                {/* Tombol Hapus (Disembunyikan kalau cuma sisa 1 POS) */}
                {posList.length > 1 && (
                  <button 
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <input type="text" defaultValue="00:00" className="w-full bg-white border border-[#CBD5E1] text-[#1D2B39] font-bold text-[15px] rounded-[12px] px-4 py-3.5 focus:outline-none focus:border-[#2E9AD7]" />
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <input type="text" placeholder="e.g. Tukar Hadiah" className="w-full bg-white border border-[#CBD5E1] text-[#1D2B39] placeholder-[#92A0AD] text-[15px] rounded-[12px] px-4 py-3.5 focus:outline-none focus:border-[#2E9AD7]" />
            </div>
            
            <div>
              <label className="block text-[14px] font-bold text-[#1D2B39] mb-1.5">Lokasi</label>
              <input type="text" placeholder="e.g. MMG (Lantai 2)" className="w-full bg-white border border-[#CBD5E1] text-[#1D2B39] placeholder-[#92A0AD] text-[15px] rounded-[12px] px-4 py-3.5 focus:outline-none focus:border-[#2E9AD7]" />
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <input type="text" className="w-full bg-white border border-[#CBD5E1] text-[#1D2B39] text-[15px] rounded-[12px] px-4 py-3.5 focus:outline-none focus:border-[#2E9AD7]" />
            </div>
            
            <div>
              <label className="block text-[14px] font-bold text-[#1D2B39] mb-1.5">QR Image</label>
              
              {/* CUSTOM FILE UPLOAD UI (Persis Figma) */}
        ...
        {/* --- TOMBOL SUBMIT --- */}
        <div className="mb-10">
          <button className="w-full bg-[#2E9AD7] text-white font-bold text-[18px] py-3.5 rounded-2xl border-2 border-[#2e84b6] shadow-[0_6px_0_0_#1C6B99] hover:bg-[#268bc4] active:shadow-[0_0_0_0_#1C6B99] active:translate-y-[6px] transition-all">
            Buat Sesi
          </button>
        </div>
